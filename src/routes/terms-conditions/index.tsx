...
export default component$(() => {
  return (
    <main class='main'>
      ...
      <br />
      <p>
        These terms and conditions applies to the Habit Flow app (hereby
        referred to as "Application") for mobile devices that was created by
        Valeriy Khoma (hereby referred to as "Service Provider") as a Freemium
        service.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        disabling data roaming. If you are not the Service Provider cannot be
        held responsible.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>These terms and conditions are effective as of 2024-06-26</p>
      <br />
